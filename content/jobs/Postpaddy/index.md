---
date: '2025-08-01'
title: 'Lead Full Stack Engineer (Campaigns)'
company: 'Postpaddy'
range: 'Aug 2025 – Present'
url: 'https://postpaddy.com'
---
- System Architecture: Solely architected "Campaigns," a robust email marketing engine. Designed the backend using Nest.js and BullMQ (Redis) to handle asynchronous job processing, ensuring reliable delivery and enforcing rate-limiting (throttling) to protect domain reputation.
